...
| Skill | 版本 | 文件数 | 职责 |
|---|---:|---:|---|
| `drama-crew` | 6.17.9 | 18 | 从选题到台词精修、文件治理、完整制作母稿及按需投稿阅读稿 |
| `drama-studio` | 1.13.6 | 30 | 从剧本交接到资产、分镜、声音、剪辑与 QC；含 Dreamina 路由与 ffmpeg 合成脚本 |
...
- `完整制作母稿.md` 是唯一内容真源；内容修改会在同一 `script_rev` 内同步梗概、人物、粗纲、集纲与正文。投稿、送制片人或对外阅读时，DOCX 工具可用便默认派生 `《剧名》_投稿阅读稿.docx`，Markdown 仅作中间稿或工具不可用时的降级载体。
